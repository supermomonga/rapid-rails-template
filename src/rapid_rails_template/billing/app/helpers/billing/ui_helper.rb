    ...
    def billing_tabs(section)
      ...
      when :admin
        [["operations", routes.admin_root_path, "banknotes", controller_path == "billing/admin/overview" && action_name == "show"],
         ...
         ["operator_plans", routes.admin_plans_path, "squares-2x2", controller_path == "billing/admin/plans"],
      ...
      when :merchant_settings
        [["profile", routes.edit_merchant_profile_path, "user-circle", controller_path == "billing/merchant/merchant_profiles"],
         ["payouts", routes.merchant_payout_addresses_path, "wallet", controller_path == "billing/merchant/payout_addresses"]]
      when :merchant_sales
        [["subscriptions", routes.merchant_sales_path, "credit-card", controller_path == "billing/merchant/sales"],
         ["payments", routes.merchant_payments_path, "banknotes", controller_path == "billing/merchant/payments"],
         ["manual_refunds", routes.merchant_refund_records_path, "arrow-uturn-left", controller_path == "billing/merchant/refund_records"]]
      when :public
