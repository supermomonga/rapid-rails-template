...
class ExecutionPlanTest < Minitest::Test
  def test_default_plan_installs_every_optional_feature_except_mail
    ...
    assert_includes plan.gems, "browser"
    ...
    assert_includes plan.artifacts, "app/controllers/admin/overview_controller.rb"
    ...
    assert_includes plan.artifacts, "app/views/admin/overview/show.html.erb"
    ...
    assert_includes plan.artifacts, "test/controllers/admin/overview_controller_test.rb"
    ...
    assert_includes plan.artifacts, "app/views/users/passkey_sessions/new.html.erb"
    assert_includes plan.artifacts, "app/views/users/passkey_registrations/new.html.erb"
    assert_includes plan.artifacts, "app/models/passkey_credential.rb"
    assert_includes plan.artifacts, "app/models/webauthn_challenge.rb"
    assert_includes plan.artifacts, "app/services/passkey_default_name.rb"
    assert_includes plan.artifacts, "test/services/passkey_default_name_test.rb"
    ...
    assert_includes plan.artifacts, "config/deploy.production.yml"
    assert_includes plan.artifacts, "config/deploy.staging.yml"
    assert_includes plan.artifacts, "config/litestream.yml"
    assert_includes plan.artifacts, "bin/kamal-maintenance"
    assert_includes plan.artifacts, "bin/kamal-restore"
    assert_includes plan.artifacts, "bin/kamal-restore-volume"
    assert_includes plan.artifacts, "lib/deployment/kamal_operation.rb"
    assert_includes plan.artifacts, "lib/deployment/command_runner.rb"
    assert_includes plan.artifacts, "lib/deployment/cloudflare_client.rb"
    assert_includes plan.artifacts, "lib/deployment/configurator.rb"
    assert_includes plan.artifacts, "lib/deployment/kamal_secrets_writer.rb"
    assert_includes plan.artifacts, "lib/deployment/one_password_client.rb"
    assert_includes plan.artifacts, "lib/deployment/server_setup.rb"
    assert_includes plan.artifacts, "lib/tasks/deployment.rake"
    assert_includes plan.artifacts, "test/lib/deployment/configurator_test.rb"
    assert_includes plan.artifacts, "test/lib/deployment/server_setup_test.rb"
  ...
  def test_siwe_plan_adds_siwe_to_devise
    ...
    assert_includes plan.artifacts, "package-lock.json"
    assert_includes plan.artifacts, "app/views/users/passkey_sessions/new.html.erb"
    assert_includes plan.artifacts, "app/controllers/users/siwe_registrations_controller.rb"
    assert_includes plan.artifacts, "app/javascript/controllers/siwe_sign_in_controller.js"
    assert_includes plan.artifacts, "app/views/shared/_siwe_provider_picker.html.erb"
    assert_includes plan.artifacts, "test/helpers/application_helper_test.rb"
    ...
    assert_includes plan.artifacts, "app/services/siwe_identity_default_name.rb"
    assert_includes plan.artifacts, "app/controllers/concerns/authentication_credential_session.rb"
    ...
    assert_includes plan.artifacts, "test/services/siwe_identity_default_name_test.rb"
    assert_includes plan.artifacts, "config/locales/application.ja.yml"
    assert_includes plan.artifacts, "config/locales/application.en.yml"
